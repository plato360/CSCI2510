...
const u16 ghostData[] = {
                    ...
                    0x0000, 0xFF00, 0x0000, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000, 0x0000, 0xFFFF,
                    0x0000, 0x0000, 0xFF00, 0xFFFF, 0x0000, 0x0000, 0xFF00, 0xFFD2, 0x0000, 0x0000,
                    0xFFFF, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000, 0x00FF, 0x0000, 0x0000, 0x0000,
                    0x00FF, 0x0000, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000, 0x0000, 0xFFFF, 0x0000,
                    0x0000, 0x0000, 0xFFFF, 0x00FF, 0x0000, 0x0000, 0xD2FF, 0x00FF, 0x0000, 0x0000,
                    0xFFFF, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000, 0xFFFF, 0xD2FF, 0x0000, 0xFF00,
                    0xFFFF, 0xFFD2, 0x0000, 0xFF00, 0xFFFF, 0xFFD2, 0x0000, 0xFFFF, 0xFFFF, 0xFFFF,
                    ...
                    0xFFD2, 0xFFFF, 0x00FF, 0x0000, 0xFFD2, 0xFFFF, 0x00FF, 0x0000, 0xFFFF, 0xFFFF,
                    0xFFFF, 0x0000, 0xFFFF, 0xFFFF, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
                    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,};

const u16 ghostPalette[] = {
